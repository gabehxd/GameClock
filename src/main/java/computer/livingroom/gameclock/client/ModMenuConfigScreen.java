        ...
        return parent -> {
            Option<Color> bgColor = Option.<Color>createBuilder()
                    ...
                    .binding(
                            ...
                            () -> HANDLER.instance().backgroundColor,
                            color -> HANDLER.instance().backgroundColor = color
                    )
                    ...
                    .category(ConfigCategory.createBuilder()
                            ...
                            .group(OptionGroup.createBuilder()
                                    ...
                                    .option(Option.<Color>createBuilder()
                                            ...
                                            .binding(
                                                    new Color(0xFFFFFF),
                                                    () -> HANDLER.instance().textColor,
                                                    color -> HANDLER.instance().textColor = color
                                            )
                                            .controller(opt -> ColorControllerBuilder.create(opt)
                                                    .allowAlpha(true))
                                            .build())
                                    ...
                                    .build())
                            .group(OptionGroup.createBuilder()
                                    .name(Component.literal("Background Options"))
                                    .option(Option.<Boolean>createBuilder()
                                            .name(Component.literal("Text Background"))
                                            .description(OptionDescription.of(Component.literal("Add a background to the clock")))
                                            .binding(
                                                    false,
                                                    () -> HANDLER.instance().enableTextBackground,
